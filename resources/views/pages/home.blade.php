  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0 mb-6">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Laravel Blog App</h1>
        ...
        <a href="/posts/create" class="mt-8 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create post</a>
